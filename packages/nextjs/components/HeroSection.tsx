...
import { useConnect, useAccount, connectors } from 'wagmi';
      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto">
            Lower your collateral ratio from 150% to 50% based on your payment history.
            Build trust, unlock capital efficiency.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 bg-monad-dark-gray rounded-lg border border-gray-800">
              <div className="w-12 h-12 mb-4 bg-monad-dark-green rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-monad-green" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-400">Build reputation with every on-time payment. Lower collateral requirements over time.</p>
            </div>
